...
interface NearestEducationProps {
  onSubmitSuccess: (values: z.infer<typeof educationFormSchema>) => void;
  onClose: () => void;
  onDelete?: () => void;
  initialValues?: z.infer<typeof educationFormSchema>;
  isEditing?: boolean;
}
