...
interface NearestStationProps {
  onSubmitSuccess: (values: z.infer<typeof stationFormSchema>) => void;
  onClose: () => void;
  onDelete?: () => void;
  initialValues?: z.infer<typeof stationFormSchema>;
  isEditing?: boolean;
}
...
export const NearestStation = ({
  ...
  function onSubmit(values: z.infer<typeof stationFormSchema>) {
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Select onValueChange={field.onChange} value={field.value}>
                      ...
                      <SelectContent>
                        <SelectItem value="Lalpur station">
                          Lalpur station
                        </SelectItem>
                        <SelectItem value="Komlapur station">
                          Komlapur station
                        </SelectItem>
                        <SelectItem value="Chandpur station">
                          Chandpur station
                        </SelectItem>
                      </SelectContent>
                    </Select>
