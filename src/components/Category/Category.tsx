...
export default function Category() {
  ...
  const cardBaseStyle =
    "border-2 rounded-[12px] p-2 cursor-pointer transition duration-200";
  ...
  return (
    <>
      <div className="w-[1280px] mx-auto pb-20">
        {/* Property type */}
        <div>
          <h1 className="text-xl font-semibold text-[#393f4e] my-4">
            Property type
          </h1>
          <div className="grid grid-cols-3 gap-5">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1>Single House Property</h1>
                  <p className="text-xs mt-1 text-[#777980]">
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-5">
            <div
              ...
              className={`border-2 rounded-[12px] p-2 cursor-pointer transition duration-200 ${
            ...
            <div>
              <div>
                <div className="mt-4 border rounded-xl overflow-hidden">
                  <div className="bg-[#F4F4F4] px-4 py-1">
                    <h2 className="text-xl font-semibold text-[#393f4e] m-0">
                      {selectedRole === "landlord"
                        ? "Proof of ownership"
                        : selectedRole === "realtor"
                  ...
                  <div className="bg-gray-50 p-3">
                    ...
                    {selectedRole === "realtor" && <RealtorForm />}
                    {selectedRole === "management" && <ManagementForm />}
                  </div>
                </div>
              </div>
              <div className="py-3">
        ...
        {/* Navigation buttons */}
        <div className="fixed bottom-0 left-0 right-0 bg-white top-shadow">
          <div className="w-[1280px] mx-auto flex items-center justify-between py-2">
            <NavLink to="/" className="border-b-2 border-[#EOEOEO]">
              Back
            </NavLink>
